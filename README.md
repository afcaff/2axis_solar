...
- **Actuation:** Two MG995 servos (pan + tilt), driven by hardware PWM
- **Display:** SSD1306 OLED (I2C) showing live pan/tilt angle and system status
- **Power:** Panel-charged LiPo battery with a shift-register LED bar gauge and push-button readout
- **Mechanical:** Custom 3D-printed pan/tilt gimbal assembly designed in Fusion 360
